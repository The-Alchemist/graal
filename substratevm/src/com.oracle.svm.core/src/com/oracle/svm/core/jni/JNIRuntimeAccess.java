...
public final class JNIRuntimeAccess {
    ...
    public static void register(Class<?>... classes) {
        getSupport().register(ConfigurationPredicate.DEFAULT_CONFIGURATION_PREDICATE, classes);
    }

    public static void register(Executable... methods) {
        getSupport().register(ConfigurationPredicate.DEFAULT_CONFIGURATION_PREDICATE, methods);
    }
    ...
    public static void register(boolean finalIsWritable, Field... fields) {
        getSupport().register(ConfigurationPredicate.DEFAULT_CONFIGURATION_PREDICATE, finalIsWritable, fields);
    }
